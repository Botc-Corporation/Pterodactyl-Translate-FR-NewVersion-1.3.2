...
return [
    ...
    'server' => [
        ...
        'reinstall' => [
            'failed' => 'Demande de Ré-installation de ":name" (#:id) sur le noeud ":node" echoué avec cette erreur: :message',
            'confirm' => 'Vous êtes sur le point de réinstaller sur un groupe de serveurs. Souhaitez-vous continuer?',
        ],
        'power' => [
            'confirm' => 'Vous êtes sur le point d\'effectuer un :action sur :count serveurs. Souhaitez-vous continuer ?',
            'action_failed' => 'Demande d\'action d\'alimentation pour ":name" (#:id) sur le noeud ":node" echoué avec cette erreur: :message',
        ],
    ],
    'environment' => [
        'mail' => [
